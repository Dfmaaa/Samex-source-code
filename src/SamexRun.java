...
public class SamexRun {
	...
	static boolean incorrectcmd(String command){
		if(command.equals("help")==false&command.equals("lock")==false&command.split(" ")[0].equals("disp")==false&command.equals("mkdir")==false&command.equals("packages")==false&command.equals("antivirus")==false&command.equals("update")==false&command.equals("content")==false&command.equals("restart")==false&command.equals("lastcmd")==false&command.equals("Atlas")==false&command.equals("uptime")==false&command.equals("rock paper scissors")==false&command.equals("zip")==false&command.equals("unzip")==false&command.equals("settings")==false&command.equals("showalpha")==false&command.equals("emdir")==false&command.equals("playfile")==false&command.equals("goto")==false&command.equals("getlines")==false&command.equals("remove duplicates")==false&command.equals("time")==false&command.equals("change password")==false&&command.equals("secret files")==false&command.equals("set password")==false&command.equals("create")==false&command.equals("remove")==false&command.equals("history")==false&command.equals("clear history")==false&command.equals("write")==false&command.equals("remove password")==false&command.equals("exists")==false&check(command.split(" "),"cd")==false&check(command.split(" "),"dir")==false&command.equals("download")==false&command.equals("shutdown")==false&command.equals("incrlvl")==false&command.equals("decrlvl")==false&command.split(" ")[0].equals("suru")==false&command.equals("rmdir")==false&command.equals("len")==false){
         return true;
		}
		else{
			return false;
